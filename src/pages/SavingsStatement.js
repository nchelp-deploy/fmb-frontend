...
export default function SavingsStatement() {
  const transactions = [
    { id: 1, date: '2025-04-01', description: 'Interest Credit', amount: 50.00, type: 'credit' },
    { id: 2, date: '2025-03-15', description: 'Deposit', amount: 1000.00, type: 'credit' },
    { id: 3, date: '2025-03-10', description: 'Withdrawal', amount: -200.00, type: 'debit' },
  ];
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-blue-100 flex flex-col items-center justify-center px-4 py-8 animate-fade-in-up">
      <div className="card max-w-2xl w-full rounded-2xl shadow-xl p-8 bg-white/90 animate-fade-in-up">
        <h2 className="text-2xl font-bold text-primary mb-6 text-center animate-fade-in">Savings Statement</h2>
