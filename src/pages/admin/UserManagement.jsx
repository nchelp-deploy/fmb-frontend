...
import { ShieldCheckIcon, UserGroupIcon, ChartBarIcon, CogIcon, BellIcon, ExclamationTriangleIcon } from '@heroicons/react/24/outline';
...
const UserManagement = () => {
  ...
  useEffect(() => {
    if (!authService.isAuthenticated() || !authService.isAdmin()) {
      ...
      fetchUsers();
  }, [navigate, currentPage, searchTerm, statusFilter, roleFilter]);
