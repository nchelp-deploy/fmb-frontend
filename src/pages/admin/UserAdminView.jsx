            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    type="number"
                    value={editedData.newBalance || ''}
                    onChange={(e) => handleChange('newBalance', e.target.value)}
                  ...
                  <button
                    onClick={async () => {
                      try {
                        ...
                        const response = await api.patch(`/admin/users/${userId}/balance`, {
                          newBalance: parseFloat(editedData.newBalance)
                        });
                        setUserData(response.data.user);
                        setEditedData(prev => ({ ...prev, newBalance: '' }));
                        alert('Balance updated successfully');
                      } catch (err) {
                        console.error('Error updating balance:', err);
                        const errorMessage = err.response?.data?.message || 'Failed to update balance';
                    ...
                    disabled={!editedData.newBalance || isNaN(editedData.newBalance)}
                  >
                    Update
                  </button>
                </div>
